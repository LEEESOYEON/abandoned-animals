...
특히, '제목 검색'기능을 구현할 때 클라이언트가 검색을 요청하면, 일치하는 내용의 데이터를 비동기적으로 가져와 동적으로 화면 구성을 했습니다.<br>
또한, '게시글 전체보기' 나 '내가 작성한 게시글 보기'와 같은 페이징 기능이 아닌, 다른 방법을 적용시켜보자 했습니다.<br>
그 결과, 일정 개수의 게시물을 보여주고 '더보기'버튼을 만들어 클릭 시 추가적인 게시물을 불러오는 방식을 적용했습니다.<br>
